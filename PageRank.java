...
import PageRank.job0.InitializePageRankMapper;
import PageRank.job0.InitializePageRankReducer;
import PageRank.job1.WikiLinksMapper;
import PageRank.job1.WikiLinksReducer;
import PageRank.job1.XmlInputFormat;
import PageRank.job2.OutGraphMapper;
import PageRank.job2.OutGraphReducer;
import PageRank.job3.CalcLinesMapper;
import PageRank.job3.CalcLinesReducer;
import PageRank.job4.CalcPageRankMapper;
import PageRank.job4.CalcPageRankReducer;
import PageRank.job5.OrderRankMapper;
import PageRank.job5.OrderRankReducer;
...
public class PageRank extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		if (!parseXml(inputXml, outputDir + "wiki/ranking/iter0--‐raw")) {
			return 1;
		}
		if (!getAdjacencyGraph("" + outputDir + "wiki/ranking/iter0--‐raw", "" + outputDir + "wiki/ranking/iter0_1"))
			return 1;
